        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Foto = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoradorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProprietarioId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProprietarioId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Apartamentos_Usuarios_ProprietarioId1",
                        column: x => x.ProprietarioId1,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SevicoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Valor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Servicos", x => x.SevicoId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "f7339779-28a8-4609-90f7-fb2fc22233de", "bc038a04-ba6f-40e2-8e63-b73e365cd9d0", "Morador do prédio", "Morador", "MORADOR" },
                    { "64802a6e-b208-45bd-bd43-afeaeebf5098", "52c1b9f3-4f97-4190-b38a-3eb45da02286", "Sindico do prédio", "Sindico", "SINDICO" },
                    { "24888c35-28bb-4b82-a4a7-faac05fdf837", "b731a6e5-f5e1-431e-bab2-af7a191c0e78", "Administrador do prédio", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartamentos_ProprietarioId1",
                table: "Apartamentos",
                column: "ProprietarioId1");
